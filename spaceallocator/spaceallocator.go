...
type Space interface {
	Accept() error
	PartiallyAccept(size uint64) error
	Release() error
}
...
func (space *spaceInstance) Accept() (err error) {
...
func (space *spaceInstance) PartiallyAccept(size uint64) (err error) {
...
func (space *spaceInstance) Release() (err error) {
...
func (allocator *allocatorInstance) removeOutdatedItems(requiredSize uint64) (freedSize uint64, err error) {
	...
	allocator.part.freeSpace(freedSize)
